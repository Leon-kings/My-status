    ...
    <>
      <div className="w-full bg-black">
        ...
        <motion.div
          ...
          className="xl:mr-0 lg:mr-0 mr-0 w-full xl:w-full lg:w-full"
        >
                          ...
                          <div className="flex items-center space-x-6 lg:space-x-8">
                            <div className="grid shrink-0 grid-cols-1 ">
                              <motion.div
                                ...
                                transition={{ duration: 0.5 }}
                                className="h-44 w-40 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100"
                              >
                                <img
                              ...
                              <motion.div
                                ...
                                className="h-44 w-40 overflow-hidden rounded-lg"
                              >
                                <img
