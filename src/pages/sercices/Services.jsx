  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">SKills</h2>
            <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">Here are some Skills we ca serve it through.</p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200 rounded shadow-md">
                <svg className="mx-auto" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t rounded shadow-md">
